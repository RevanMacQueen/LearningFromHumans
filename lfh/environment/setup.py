...
class Environment:
    ...
    def __init__(self, env_params, log_params, logger, seed,
        ...
        if train:
            ...
            logger.info("Action space: {0}".format(self.env.action_space.n))
            logger.info("Action meaning: {0}".format(self.env.unwrapped.get_action_meanings()))
            logger.info("Observation space: {0}".format(self.env.observation_space.shape))
